...
import { Alert, Animated, Dimensions, StyleSheet, View, Text, Image, TouchableOpacity, Button, TextInput, Platform, TouchableWithoutFeedback, ScrollView, AsyncStorage} from 'react-native';
import {
    Ionicons,
    FontAwesome,
    MaterialIcons,
            ...
            <View style= {{justifyContent:'center', alignContent:'center',  
                    width:Dimensions.get('window').width}}>
                        ...
                        <View style={[{marginTop:50 , paddingHorizontal:20 }]}>
                            <Button style={{width:300}} color={primary} title="Sign In" onPress={this._login}/>
                        </View >
...
_login = async(props) =>{
        ...
        Alert.alert('Wrong Input!', 'Email or Password feild cannot be empty',[{text:'Okay'}]); 
